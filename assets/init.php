...
$requires = [
    ...
    // CRM Automation Helpers (NEW)
    INCLUDES_DIR . '/pdf_generator.php',
    INCLUDES_DIR . '/crm_document_storage.php',
    INCLUDES_DIR . '/invoice_auto_features.php',
    INCLUDES_DIR . '/excel_schedule_generator.php',
];
